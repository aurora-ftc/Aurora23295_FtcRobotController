...
@Autonomous(name = "Bot3RedNear", group = "Bot3Autos")
@Configurable // Panels
public class Bot3RedNear extends OpMode {
    ...
    // Poses
    private final Pose startPose = new Pose(120, 120, Math.toRadians(180));
    private final Pose launchPose = new Pose(98, 100, Math.toRadians(180));
    private final Pose pickup3StartPose = new Pose(100, 32, Math.toRadians(180));
    private final Pose pickup3EndPose = new Pose(125, 32, Math.toRadians(180));
    private final Pose pickup2StartPose = new Pose(100, 52, Math.toRadians(180));
    private final Pose pickup2EndPose = new Pose(125, 52, Math.toRadians(180));
    private final Pose pickup1StartPose = new Pose(100, 80, Math.toRadians(180));
    private final Pose pickup1EndPose = new Pose(120, 80, Math.toRadians(180));
    private final Pose parkPose = new Pose(98, 70, Math.toRadians(180));
    ...
    public void init() {
        ...
        ts2.setPosition(0.71);
        ts1.setPosition(0.71);
