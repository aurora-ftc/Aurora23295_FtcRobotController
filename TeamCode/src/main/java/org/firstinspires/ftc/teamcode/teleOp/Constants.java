...
public class Constants {
        ...
        public static class HWMap {
                ...
                public static String SELECTOR_MOTOR = "selector_motor";
                public static String SELECTOR_SERVO = "selector_servo";
                public static String COLOR_SENSOR_1 = "color_sensor_1";
                public static String COLOR_SENSOR_2 = "color_sensor_2";
                public static String COLOR_SENSOR_3 = "color_sensor_3";
        }
