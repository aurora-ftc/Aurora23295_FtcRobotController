...
@Autonomous(name = "ChoppedAutoRed", group = "ChoppedAutos")
public class ChoppedAutoRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(opModeIsActive()) {
            ...
            sleep(550);
            mecanumDrive.drive(0, 0 , 0.2, 1,telemetry); //Rotate Clockwise
            sleep(500);
            ...
            launchSystem.updateLauncher();
            sleep(500);
            mecanumDrive.driveFieldOriented(0.7, 0 , -0.5, 1,telemetry);//Rotate intake to balls
            sleep(1000);
            mecanumDrive.drive(0, 0 , 0, 0,telemetry);
            sleep(300);
            mecanumDrive.drive(-0.3, 0, 0, 0, telemetry);
            sleep(2000);
            mecanumDrive.drive(0, 0 , 0, 0,telemetry);
            sleep(300);
        }
