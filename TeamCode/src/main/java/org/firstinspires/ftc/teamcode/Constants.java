...
public class Constants {
    ...
    public static double[] POWER_STEPS = {45, 12, 42, 44, 45, 46, 47, 48, 50, 51, 52,
            53, 54, 56, 58, 63, 65, 67, 73.2, 85}; //{40, 42, 44, 85} old one idk why no work
    ...
    public static class HWMap {
        ...
        public static String INDEXER_SERVO = "indexer_servo";
        ...
        public static String CS_BOTTOM = "cs_bottom";
        public static String CS_RIGHT = "cs_right";
        public static String CS_LEFT = "cs_left";
